...
$c=new Client("Boys and Girls Club  Beaufort","","BFT","recipient","17 B Marshell Lane","Beaufort","SC",29902,"","9865437","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Sam Burke"); insert_dbClients($c);
...
$c=new Client("Church of God and Unity","","BFT","recipient","PO Box","Ladys Island","SC",29907,"","","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds",""); insert_dbClients($c);
...
$c=new Client("Parks and Leisure SeniorsBft","","BFT","recipient","1514 Richmond Avenue","Port Royal","SC",29935,"","4706321","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Ms. Washington"); insert_dbClients($c);
...
$c=new Client("Women of Faith and Power","","BFT","recipient","71 Holly Hall Road","Beaufort","SC",29902,"","3223202","6832026","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Mary Simmons"); insert_dbClients($c);
...
$c=new Client("Collins and James","","HHI","donor","8 Arccher Road","Hilton Head Island","SC",29926,"","6966388","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Jim and Alex Hazelto"); insert_dbClients($c);
...
$c=new Client("Marriott Beach and Golf resort","","HHI","donor","1 Hotel Circle","Hilton Head Island","SC",29928,"","6868400","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Michael Stocker, C"); insert_dbClients($c);
...
$c=new Client("Boys and Girls Club  HHI","","HHI","recipient","PO Box 22267","Hilton Head Island","SC",29925,"","6893646","","Mon,Tue,Wed,Fri","no","pounds","Irving Campbell"); insert_dbClients($c);
...
$c=new Client("Boys and Girls Club  Bluffton","","SUN","recipient","PO Box 1908","Bluffton","SC",29910,"","7062300","","Tue,Fri","no","pounds","Molly O. Smith"); insert_dbClients($c);
$c=new Client("Boys and Girls Club  Okatie","","SUN","recipient","5855 S. Okatie Highway","Hardeeville","SC",29927,"","7846008","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","robert Huff 71711"); insert_dbClients($c);
$c=new Client("Boys and Girls Club  Ridgeland","","SUN","recipient","PO Box 1482","Ridgeland","SC",29936,"","8124357","","Mon,Thu","no","pounds","Keith Alston"); insert_dbClients($c);
...
$c=new Client("Parks and Rec.  Bluffton","","SUN","recipient","PO Box 205","Bluffton","SC",29910,"","7571503","","Mon,Tue,Wed,Thu,Fri,Sat","no","pounds","Barbara Campbell"); insert_dbClients($c);
