...
function validate_form($id){
	...
	if($_POST['type']=='recipient' && ($_POST['number_served']==null || !is_numeric($_POST['number_served']))) $errors[] = "Please enter a valid adults served" ;
	if($_POST['type']=='recipient' && ($_POST['children_served']==null || !is_numeric($_POST['children_served']))) $errors[] = "Please enter a valid children served" ;
	if($_POST['type']=='recipient' && ($_POST['seniors_served']==null || !is_numeric($_POST['seniors_served']))) $errors[] = "Please enter a valid seniors served" ;
