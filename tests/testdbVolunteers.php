...
class testdbVolunteers extends UnitTestCase {
	function testdbVolunteersModule() {
		...
		//Test volunteers
		$vol1 = new Volunteer("Brody", "Hartley", "1 Scarborough Head Rd","Hilton Head", "SC", "29928", "8431112345", "", 
    				"Hartley.Brody@gmail.com", "driver", "active", "HHI", "123456789","SC", "14-01-29", "", "", "Wed:3,Fri:4","",
    				"", "59-01-01","98-01-01", "", "");
        $vol2 = new Volunteer("Hopkins", "Richardo", "1 Scarborough Head Rd","Hilton Head", "SC", "29928", "8432222345", "", 
    				"milkywayw@gmail.com", "driver", "active", "HHI", "234567890","SC", "14-01-29", "", "", "Wed:1,Fri:5","",
    				"", "59-01-01","98-01-01", "", "");
        $vol3 = new Volunteer("Wetzel", "Nick", "1 Scarborough Head Rd","Hilton Head", "SC", "29928", "8433332345", "", 
    				"nwetzel41@gmail.com", "driver", "active", "HHI", "345678901","SC", "14-01-29", "", "", "Wed:2,Fri:1","",
    				"", "59-01-01","98-01-01", "", "");
        $vol4 = new Volunteer("Peluso", "Jon", "1 Scarborough Head Rd","Hilton Head", "SC", "29928", "8434442345", "", 
		...
		//Test Retrieve
		$this->assertEqual(retrieve_dbVolunteers($vol1->get_id())->get_id (), "Hartley8431112345");
		...
		$this->assertEqual(retrieve_dbVolunteers($vol1->get_id())->get_phone1 (), 8431112345);
		...
		$vol2 = new Volunteer("Hopkins", "Richardo", "444 Park","Hilton Head", "SC", "29928", "8432222345", "", 
    				"milkywayw@gmail.com", "driver", "active", "HHI", "234567890","SC", "14-01-29", "", "", "Wed:1,Fri:5","",
    				"", "59-01-01","98-01-01", "", "");
