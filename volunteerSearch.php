				...
				// display the search form
					...
					echo('<form method="post">');
						...
						echo('&nbsp;&nbsp;Type:<select name="s_type">' .
							...
							'<option value="teamcaptain">Team Captain</option>' . '<option value="coordinator">Staff/Board</option>' .
							'</select>');
						echo('&nbsp;&nbsp;Status:<select name="s_status">' .
							'<option value=""></option>' . '<option value="applicant">Applicant</option>' . '<option value="active" SELECTED>Active</option>' .
							'<option value="on-leave">On Leave</option>' . '<option value="former">Former</option>' .
							'</select>');
						echo '<p>Name: ' ;
						echo '<input type="text" name="s_name">';
						echo '<fieldset>';
						echo '<legend>Monthly Availability:</legend>';
